...
public class LoginRestService {
    ...
    @ResponseBody
    public UserRegistrationResponse register(@RequestBody UserRegisterRequest userRegisterRequest) throws ApplicatonError {
    ...
    @PostMapping("login/")
    @ResponseBody
    public UserLoginResponse login(@RequestBody UserLoginRequest userLoginRequest) throws ApplicatonError {
