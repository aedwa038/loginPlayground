...
public class UserLoginService {
    ...
    @Transactional
    public UserLoginResponse loginUser(UserLoginRequest request) throws ApplicatonError{
    ...
    @Transactional
    public UserRegistrationResponse register(UserRegisterRequest request) throws ApplicatonError {
